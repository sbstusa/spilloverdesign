...
usaCountiesPopCenters<-read.csv(url("http://www2.census.gov/geo/docs/reference/cenpop2010/county/CenPop2010_Mean_CO.txt"))

usaCounties<-read.dbf("gis/AddCombiFips/USACountyCentroids.dbf")
